...
export const first = [<>
	<Page title={'Unit 1 - Trigonometric Identities'} important={<></>} content={<>
			...
			For Example, these two sides can be proven using know identities of the part: 
					...
					<br></br>
					<button id="calltrigIdentity1Solution" onClick={() => {document.getElementById("trigIdentity1Solution").style.display = "inline"}}>See Solution: </button>
				</p>
